...
public class GameScoreboard implements IScoreboard {
    ...
    public void initScoreboard() {
        ...
        this.player.getScoreboard().setObjectiveName("§8- §6§lPitchout §a10:00 §8-");
    ...
    private int updatePlayers(int index) {
        this.player.getScoreboard().setLine(index++, "§eSurvivant(s) : §b" + GameManager.getInstance().getPlayers().size());
        return index;
    }
}
